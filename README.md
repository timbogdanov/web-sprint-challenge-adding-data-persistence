...
1. Explain the difference between `Relational Databases` and `SQL`.
   A relational database is a type of database that is structures to work with different tables and recognize the relations with them. On the other hand a SQL is a query language that lets you read and manipulate the data in the database.

2. Why do tables need a `primary key`?
   Every table needs a primary key to keep track on inserted records.
